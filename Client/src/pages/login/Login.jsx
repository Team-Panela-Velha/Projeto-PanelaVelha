            ...
            <form className="flex flex-col items-center justify-center gap-8 w-4/5 sm:w-3/5 lg:w-2/5 h-3/4 bg-slate-100 rounded-lg tela-login" onSubmit={enviarDados}>
                ...
                <div className="w-3/12">
                    <div className="flex justify-center">
                        <button className="bg-redwood w-20 h-10 rounded-sm" type="submit"><p className="text-white">{isLoading ? 'Enviando...' : 'Entrar'}</p></button>
                    </div>
                </div>
                <div className="w-full mt-24">
                    <p className="pl-[10%]">Não possui uma conta? <Link to="/cadastro" className="text-redwood">Cadastre-se</Link></p>    
                </div>        
            </form> 
        </div>
