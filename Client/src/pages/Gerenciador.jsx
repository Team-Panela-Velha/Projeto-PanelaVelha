        ...
        <>
            ...
            <div className="flex flex-col items-center gap-10 mt-12">
                ...
                <div className="flex gap-5">
                    <Link to="/gerenciadorUsuarios"><div className="flex  flex-col justify-center items-center bg-redwood w-64 h-48 rounded-xl transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg">
                        <i class="bi bi-people-fill text-4xl"></i>
                        <h3 className="text-3xl uppercase">Usuario</h3>
                    </div></Link>
                    <Link to="/gerenciadorCategorias">
