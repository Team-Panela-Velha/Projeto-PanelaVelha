...
const Receita = () => {
    return (
        <div className="w-48 h-64 p-3 bg-gray-100 relative shadow-lg">
            <div className="bg-orange-200 h-2/5 w-full rounded-md transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-lg"></div>
            <div className="pt-4">
                <p className="font-bold text-lg leading-tight">Product title</p>
                <p className="text-sm text-gray-700 mb-2">Product description and details</p>
            </div>
            <div className="flex justify-between items-center pt-2 border-t border-gray-300">
                <span className="font-bold">$499.49</span>
                <button className="flex items-center justify-center p-1 border border-gray-900 rounded-full transition-colors duration-300 ease-in-out hover:bg-orange-200 hover:border-orange-200">
