...
const Receita_Populares = () => {
  ...
  return (
       ...
       <div className="flex flex-wrap md:flex-nowrap justify-center sm:justify-start lg:justify-center gap-4 p-4 mr-10 bg-slate-100 rounded-md shadow-lg w-[98%] md:overflow-x-auto md:snap-x md:snap-mandatory">
