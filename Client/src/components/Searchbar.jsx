...
function Searchbar() {
    return (
        <form className="relative flex items-center w-[180px] h-[35px] bg-white rounded-2xl">
            ...
            <input className="flex-1 text-sm bg-transparent w-full h-full px-2 py-2 border-none placeholder:text-gray-400 focus:outline-none" placeholder="Pesquisar" required type="text" />
